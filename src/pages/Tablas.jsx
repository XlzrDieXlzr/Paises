        ...
        <div className="pt-4">
             ...
             <div>
                ...
                <DataTable  stripedRows showGridlines   value={datos}  header={header} footer={footer} paginator   rows={5} rowsPerPageOptions={[5, 10, 25, 50]}>
                    ...
                    <Column field="name.common" sortable  header="Nombre" className="text-primary" />
                    <Column field="capital" sortable  header="Capital" className="text-primary" />
                    <Column field="region" sortable  header="Region" className="text-primary" />
                    <Column field="subregion" sortable  header="Sugregion" className="text-primary" />
                    <Column field="languages" header="Idioma(s)" className="text-primary"    body={(rowData) => Object.values(rowData.languages).join(', ')} />
                    <Column field="population"  header="Población" className="text-primary" body={(rowData) => formatNumber(rowData.population)}  style={{ textAlign: 'right' }}  />
